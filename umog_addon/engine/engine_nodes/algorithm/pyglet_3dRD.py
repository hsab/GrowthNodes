...
class ReactionDiffusionNode(bpy.types.Node,EngineNode):
    bl_idname = "engine_ReactionDiffusionVoxelGPUNode"
    bl_label = "Voxel Reaction Diffusion Node"
    ...
    iterations = bpy.props.IntProperty(default=50, soft_min=1)
    ...
    def get_operation(self, input_types):
        ...
        return engine.Operation(
            engine.REACTION_DIFFUSION_VOXEL_GPU,
