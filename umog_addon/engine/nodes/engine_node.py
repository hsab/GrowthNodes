...
class EngineNode:
    ...
    def poll(cls, nodeTree):
        return nodeTree.bl_idname == "engine_EngineNodeTree"
...
class EngineOutputNode(EngineNode):
    _IsOutputNode = True
...
class EngineIntputNode(EngineNode):
    _IsInputNode = True

    def init(self, context):
        super().init(context)

class EngineBinaryScalarNode(EngineNode):
