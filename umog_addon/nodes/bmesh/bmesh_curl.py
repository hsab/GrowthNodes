...
class BMeshCurlNode(bpy.types.Node, UMOGOutputNode):
    ...
    def draw_buttons(self, context, layout):
        ...
        layout.prop_search(self, "mesh_name", bpy.data, "objects",
                           icon="MESH_CUBE", text="")
    ...
    def execute(self, refholder):
        ...
        bm.from_mesh(
            bpy.data.meshes[bpy.data.objects[self.mesh_name].data.name])
        ...
        for vert in bm.verts:
            ...
            factor = (refholder.np2dtextures[texture_handle].item(cx, cy,
                                                                  3)) + 0.1
