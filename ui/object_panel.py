...
# custom list
class UMOG_UL_ObjectListItem(UIList):
...
class UMOGObjectPanel:
    ...
    def draw(self, context):
        ...
        if scn.props.ToggleObjectList:
            row.template_list("UMOG_UL_ObjectListItem", "", scn, "objects", scn, "objects_index", rows=rows)
...
class UMOGObjectPanel3dView(bpy.types.Panel, UMOGObjectPanel):
    bl_category = "GrowthNodes"
    bl_idname = "UMOG_PT_ObjectPanel_view"
