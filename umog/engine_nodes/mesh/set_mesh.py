...
from ...engine import types, engine, mesh, data#, alembic
import bpy
import bmesh

class SetMeshNode(bpy.types.Node, EngineOutputNode):
    bl_idname = "engine_SetMeshNode"
    ...
    def output_value(self, value):
        ...
        if isinstance(value, mesh.Mesh):
            ...
            mesh.to_blender_mesh(value.frames[-1], bpy.data.meshes[self.mesh_name])
            bpy.data.meshes[self.mesh_name].update(calc_edges=True)
