...
class UMOGNodeTreeProperties(bpy.types.PropertyGroup):
    ...
    TexturePreviewInPanel : BoolProperty(name="Toggle Frame Settings", default = False, description="Disables the preview instance in GrowthNodes panel")
